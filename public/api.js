exports.getTests = function (data, stream) {
    ...
    var send = [
        ...
        {index: 4, name: 'D', duration: 0.003, status: 'Failed', vis_state: 'danger', date: '2/2/12'},
        ...
        {index: 8, name: 'H', duration: 0.003, status: 'Passed', vis_state: 'success', date: '3/3/13'},
        {index: 9, name: 'I', duration: 0.003, status: 'Failed', vis_state: 'danger', date: '2/2/12'},
        ...
        {index: 13, name: 'N', duration: 0.003, status: 'Failed', vis_state: 'danger', date: '2/2/12'},
        {index: 14, name: 'M', duration: 0.003, status: 'Failed', vis_state: 'danger', date: '2/2/12'},
        {index: 15, name: 'O', duration: 0.003, status: 'Failed', vis_state: 'danger', date: '2/2/12'},
        ...
        {index: 24, name: 'X', duration: 0.003, status: 'Passed', vis_state: 'success', date: '3/3/13'},
